...
uhndata <- read_csv2("/Users/Ivanics/Desktop/Research/92. UK vs US vs CAN/Data/UHN data/UHN_HCC_LT_masterfile_merged_with_AI_file_Jan3.csv", guess_max = 300000)
...
uhndata <- uhndata %>% mutate(RAGE = AGE)
