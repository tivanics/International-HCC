...
cox1 <- coxph(formula= Surv(PSURV_years,PCENS)~bound3$COUNTRY+
              ...
              bound3$DSEX+
              bound3$TX_YR,
              subset = MILAN == "Milan" & PSURV_years > 0.2464066 & PSURV_years <= 2,
        data=bound3)
forest_model(cox1) 
...
cox1 <- coxph(formula= Surv(PSURV_years,PCENS)~bound3$COUNTRY+
              ...
              bound3$DSEX+
              bound3$TX_YR,
              subset = MILAN == "Milan" & PSURV_years > 2 & PSURV_years <= 5,
        data=bound3)
forest_model(cox1) 
...
modelFitpre <- with(UKvUSvCANvsUHNforimputation, 
              ...
              MAX_TUMOR +
              STRAT_AFP+
              TX_YR, subset = COUNTRY != "CAN", data=UKvUSvCANvsUHNforimputation))
summary(modelFitpre)

#Overall with tumor characteristics
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              STRAT_AFP+
              TX_YR, 
              subset = COUNTRY != "CAN" & PSURV_years <= 0.2464066))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              STRAT_AFP +
              TX_YR, 
              subset = COUNTRY != "CAN" & PSURV_years > 2 & PSURV_years <= 5))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              STRAT_AFP+
              TX_YR,
              subset = COUNTRY != "CAN" & MILAN == "Milan"))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              STRAT_AFP+
              TX_YR, 
              subset = COUNTRY != "CAN" & MILAN == "Milan" & PSURV_years <= 0.2464066))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              STRAT_AFP+
              TX_YR, 
              subset = COUNTRY != "CAN" & MILAN == "Milan" & PSURV_years > 0.2464066 & PSURV_years <= 2))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              STRAT_AFP +
              TX_YR, 
              subset = COUNTRY != "CAN" & MILAN == "Milan" & PSURV_years > 2 & PSURV_years <= 5))
summary(pool(coximpute), conf.int = T, exponentiate = T)

#Uni
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY, subset = COUNTRY != "CAN"))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              DTYPE+
              DSEX+
              TX_YR, subset = COUNTRY != "CAN" & PSURV_years <= 0.2464066,))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              DTYPE+
              DSEX+
              TX_YR, subset = COUNTRY != "UHN" & PSURV_years <= 0.2464066,))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              DSEX+
              TX_YR,
              subset = COUNTRY != "UHN" & PSURV_years > 0.2464066 & PSURV_years <= 2))
summary(pool(coximpute), conf.int = T, exponentiate = T)
#Landmark 2 years to 5 years
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              CIT+
              ...
              DSEX+
              TX_YR,
              subset = COUNTRY != "UHN" & PSURV_years > 2 & PSURV_years <= 5))
summary(pool(coximpute), conf.int = T, exponentiate = T)

#Uni
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY, subset = COUNTRY != "UHN"))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
#UHN vs CAN
#Uni
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY, subset = COUNTRY == "UHN" | (COUNTRY == "CAN" & UHN == 0)))
summary(pool(coximpute), conf.int = T, exponentiate = T)
...
coximpute <- with(init1, coxph(Surv(PSURV,PCENS)~ COUNTRY+
              ...
              DTYPE+
              DSEX+
              TX_YR, subset = COUNTRY == "UHN" | (COUNTRY == "CAN" & UHN == 0)))
summary(pool(coximpute), conf.int = T, exponentiate = T)
```
